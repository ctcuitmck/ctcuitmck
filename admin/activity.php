...
<head>
  ...
  <title>CYBER TROOPS ACTIVITIES</title>
</head>

<body>
  <nav class="navbar navbar-light justify-content-center fs-3 mb-5" style="background-color:grey;">
   Cyber Troops Activity
  </nav>
  <div class="container">
    <?php
    if (isset($_GET["msg"])) {
    ...
    ?>
	<p align="center"><h3>Activities form for Cyber Troops Club</h3></p>
